...
namespace CheatOnYourDayOnes.UI
{
    public sealed class PremiumHUDCanvas : MonoBehaviour
    {
        ...
        private void BuildTacho(Transform root)
        {
            ...
            Image face=ImageEl(tr,"Face",new Color(.012f,.014f,.018f,.48f),_circleSprite);SetRect(face.rectTransform,new Vector2(-125,125),new Vector2(238,238),new Vector2(1,0));RectTransform dial=Empty(tr,"Dial",new Vector2(-125,125),Vector2.zero,new Vector2(1,0));float radius=103f;
