...
namespace CheatOnYourDayOnes.UI
{
    ...
    {
        private static readonly Color Panel = new(0.02f,0.022f,0.026f,0.40f);
        private static readonly Color PanelStrong = new(0.02f,0.022f,0.026f,0.58f);
        private static readonly Color Text = new(0.98f,0.98f,0.96f,1f);
        private static readonly Color Muted = new(0.70f,0.70f,0.68f,1f);
        private static readonly Color Track = new(0.05f,0.05f,0.055f,0.85f);
        private static readonly Color Health = new(0.93f,0.24f,0.30f,1f);
        private static readonly Color Hunger = new(1.00f,0.68f,0.22f,1f);
        ...
        private static void DrawLine(Rect r,Color c){Color old=GUI.color;GUI.color=c;GUI.DrawTexture(r,Texture2D.whiteTexture);GUI.color=old;}
